<?php
    $hotels = [
        [
            ...
            'description' => 'Ottimo hotel per famiglie',
            'parking' => true,
            'vote' => 4,
        ...
        [
            'name' => 'Hotel Futuro',
            'description' => 'Un ambiente futuristico ti aspetta',
            'parking' => true,
            'vote' => 2,
        ...
        [
            'name' => 'Hotel Rivamare',
            'description' => 'Goditi questa vacanza',
            'parking' => false,
            'vote' => 1,
        ...
        [
            ...
            'description' => 'Bevi prendi il sole rilassati',
            'parking' => false,
            'vote' => 5,
        ...
        [
            'name' => 'Hotel Milano',
            'description' => 'Cielo grigio sempre',
            'parking' => true,
            'vote' => 2,
